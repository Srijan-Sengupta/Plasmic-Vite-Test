...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: ny-wZEoEl5Xo/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: StaEeCN7JXCz/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: DIRA4kNuaO-O/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__crChe)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__cDjl)}
              role={"img"}
            />
          ),
