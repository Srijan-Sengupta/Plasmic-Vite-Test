...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: C6un1MW740Gi/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: DIRA4kNuaO-O/icon
import Icon38Icon from "./icons/PlasmicIcon__Icon38"; // plasmic-import: mX7oVK-3LnS1/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__kjowq)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon38Icon
                className={classNames(projectcss.all, sty.svg__qkDxw)}
                role={"img"}
              />
            ),
